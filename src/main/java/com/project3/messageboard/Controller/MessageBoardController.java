...
public class MessageBoardController {
    ...
    public String messageboardlist(Model model) {
        ...
        //list 라는 이름으로 반환해서 넘김
        model.addAttribute("list", messageBoardService.messageboardList());
        return "boardlist";
    }
    ...
    public String boardUpdate(@PathVariable("id") Integer id, Messageboard board, MultipartFile file) throws Exception{
