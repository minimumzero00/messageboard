...
package com.project3.messageboard.news.dto;
...
public class NewsBoardDto {
    ...
    public NewsBoard toEntity() {
        NewsBoard build = NewsBoard.builder()
                .id(id)
                .author(author)
                .title(title)
                .content(content)
    ...
    public NewsBoardDto(Long id, String author, String title, String content, Long fileId, LocalDateTime createdDate, LocalDateTime modifiedDate) {
        this.id = id;
        this.author = author;
        this.title = title;
