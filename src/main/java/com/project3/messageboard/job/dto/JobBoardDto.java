...
package com.project3.messageboard.job.dto;
...
public class JobBoardDto {
    ...
    public JobBoard toEntity() {
        JobBoard build = JobBoard.builder()
                .id(id)
                .author(author)
                .title(title)
                .content(content)
    ...
    public JobBoardDto(Long id, String author, String title, String content, Long fileId, LocalDateTime createdDate, LocalDateTime modifiedDate) {
        this.id = id;
        this.author = author;
        this.title = title;
