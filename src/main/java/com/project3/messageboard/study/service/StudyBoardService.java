...
public class StudyBoardService {
    private StudyBoardRepository freeBoardRepository;

    public StudyBoardService(StudyBoardRepository freeBoardRepository) {
        this.freeBoardRepository = freeBoardRepository;
    }

    @Transactional
    public Long savePost(StudyBoardDto boardDto) {
    ...
    public List<StudyBoardDto> getBoardList() {
        List<StudyBoard> boardList = freeBoardRepository.findAll();
        List<StudyBoardDto> boardDtoList = new ArrayList<>();

        for(StudyBoard board : boardList) {
            StudyBoardDto boardDto = StudyBoardDto.builder()
                    .id(board.getId())
    ...
    public StudyBoardDto getPost(Long id) {
        ...
        StudyBoard board = freeBoardRepository.findById(id).get();
